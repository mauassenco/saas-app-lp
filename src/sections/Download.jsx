...
/**
 * The Download component renders a section with a call-to-action to download
 * the Xora app, and a preview of the app's UI.
 */
const Download = () => {
  return (
    <section>
      ...
      >
        <div className="container">
          <div className="flex items-center">
            <div className="max-lg:flex256 relative mr-6 flex-540 max-xl:flex-280 max-md:flex-100">
              ...
              <ul className="flex flex-wrap items-center gap-6">
                {/* Loop through the links array and render a link for each item */}
          ...
          <ul className="mt-24 flex justify-center max-lg:hidden">
            {/* Loop through the logos array and render an image for each item */}
